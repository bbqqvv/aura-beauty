            ...
            {imageURLs.map((item, index) => (
              <div key={index} style={{ display: 'flex', gap: '1rem', alignItems: 'flex-end', marginBottom: '1rem', background: '#f8fafc', padding: '1rem', borderRadius: '8px' }}>
                ...
                <div>
                  ...
                  <input type="color" value={item.color?.clrCode || '#000000'} onChange={(e) => updateGalleryImage(index, 'clrCode', e.target.value, true)} style={{ height: '38px', width: '50px', padding: '0', border: '1px solid var(--admin-border)', borderRadius: '4px' }} />
                </div>
                <div style={{ flex: 2 }}>
